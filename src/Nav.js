...
import Thisishulu from './assets/hulu/fyc/fyclogo.png'
            ...
            {/* <div className="about">
              ...
              {/* <div className="projects"> */}
                ...
                <ul className="works">
                  ...
                  <li className="hulu"><NavLink onClick={() => this.closeMenu()} exact to="/projects/Hulu" activeClassName="active"><img src={Hulu} alt="VW Golf Rrr" width="90%"></img></NavLink></li>
